...
public static partial class IOUtilities
{
    ...
    public static FileAttributes? PathGetAttributes(string? path)
    {
        ...
        if (!GetFileAttributesExW(path, GetFileExInfoStandard, ref data))
            return null;
...
#pragma warning restore IDE1006 // Naming Styles
    ...
    private static partial bool GetFileAttributesExW(string name, int fileInfoLevel, ref WIN32_FILE_ATTRIBUTE_DATA lpFileInformation);

    [LibraryImport("shlwapi", StringMarshalling = StringMarshalling.Utf16)]
    private static partial int PathMatchSpecExW(string pszFile, string pszSpec, int dwFlags);
}
