...
public static class Conversions
{
    ...
    public static string ToHexa(this byte[] bytes, bool addEllipsis = false) => bytes != null ? bytes.ToHexa(0, bytes.Length, addEllipsis) : "0x";
    public static string ToHexa(this byte[] bytes, int count, bool addEllipsis = false) => bytes.ToHexa(0, count, addEllipsis);
    ...
    public static string? ToHexaDump(string text, Encoding? encoding = null)
    {
        ...
        return encoding.GetBytes(text).ToHexaDump();
    }

    public static string ToHexaDump(this byte[] bytes) => bytes.ToHexaDump(null);
    public static string ToHexaDump(this byte[] bytes, string? prefix)
    {
        ArgumentNullException.ThrowIfNull(bytes);
        return bytes.ToHexaDump(0, bytes.Length, prefix, true);
    }

    public static string ToHexaDump(this nint ptr, int count) => ptr.ToHexaDump(0, count, null, true);
    public static string ToHexaDump(this nint ptr, int offset, int count, string? prefix = null, bool addHeader = true)
    {
        using var writer = new StringWriter();
        ptr.WriteHexaDump(writer, offset, count, prefix, addHeader);
        return writer.ToString();
    }

    public static void WriteHexaDump(this byte[] bytes, TextWriter writer, string? prefix = null) => bytes.WriteHexaDump(writer, 0, bytes.Length, prefix, true);
    public static void WriteHexaDump(this nint ptr, TextWriter writer, int count) => ptr.WriteHexaDump(writer, 0, count, null, true);
    public static void WriteHexaDump(this nint ptr, TextWriter writer, int offset, int count, string? prefix = null, bool addHeader = true)
    {
        ...
        bytes.WriteHexaDump(writer, 0, count, prefix, addHeader);
    }

    public static string ToHexaDump(this byte[] bytes, int count) => bytes.ToHexaDump(0, count, null, true);
    public static string ToHexaDump(this byte[] bytes, int offset, int count) => bytes.ToHexaDump(offset, count, null, true);
    public static string ToHexaDump(this byte[] bytes, int offset, int count, string? prefix = null, bool addHeader = true)
    {
        using var writer = new StringWriter();
        bytes.WriteHexaDump(writer, offset, count, prefix, addHeader);
        return writer.ToString();
    }

    public static void WriteHexaDump(this byte[] bytes, TextWriter writer, int count) => bytes.WriteHexaDump(writer, 0, count, null, true);
